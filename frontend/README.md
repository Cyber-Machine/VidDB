...
The API allows browser requests from `http://localhost:4173` and `http://127.0.0.1:4173` by default. Set `VIDEODB_CORS_ORIGINS` to a comma-separated list when using another local origin.
