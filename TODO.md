...
## Next: explainability frontend and ingestion UX

These are the next small, reviewable changes after the Python foundation. The goal is a Pegasus-like visual workspace where every result can be traced back to a time range, model output, and source frame.
